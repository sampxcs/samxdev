...
export default function Footer() {
  return (
    <footer className={styles.footer}>
      <Container>
        <div className={styles.content}>
          <div className={styles.section}>
            ...
            <p>
              ¿Tienes un proyecto emocionante en el que necesites ayuda?, sigueme en mis redes
              sociales y no dudes en contactarme para charlar.
            </p>
            <p>
          ...
          <div className={styles.section}>
            ...
            <ul className={styles.section}>
              <li>
                <Link className={styles.link} target="_blank" href="https://github.com/sampxcs">
                  <GitHub width="1rem" />
                  GitHub
                </Link>
              </li>
              <li>
                <Link
                  ...
                  target="_blank"
                  href="https://www.linkedin.com/in/ian-samuel-rosales-leon-38a5b3230"
                >
                  <LinkedIn width="1rem" />
                  LinkedIn
                </Link>
              ...
              <li>
                <Link className={styles.link} target="_blank" href="https://twitter.com/samxdev">
                  <Twitter width="1rem" />
                  Twitter
                </Link>
              </li>
              <li>
                <Link
                  className={styles.link}
                  target="_blank"
                  href="https://www.instagram.com/iansrlx"
                >
      ...
      <address className={styles.address}>CABA, PROVINCIA DE BUENOS AIRES, ARGENTINA.</address>
      <Particles />
    </footer>
  )
}
