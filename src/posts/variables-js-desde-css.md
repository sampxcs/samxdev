...
_La función `attr()` de CSS se usa para recuperar el valor de un atributo del elemento seleccionado y usarlo en la hoja de estilos. Se puede usar también en un pseudo-elemento y, en este caso, el valor del atributo en el elemento originado del pseudo-elemento es devuelto._

_La función `attr()` de CSS se puede usar con cualquier propiedad de CSS._
...
```html
<div class="element" data-content="before content">Childrens</div>
```
